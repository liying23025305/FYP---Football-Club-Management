...
CREATE TABLE IF NOT EXISTS `mydb`.`membership_tiers` (
  ...
  `created_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`tier_id`),
  UNIQUE INDEX `tier_name_UNIQUE` (`tier_name` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`user_memberships` (
  ...
  INDEX `fk_user_memberships_users_idx` (`user_id` ASC) VISIBLE,
  INDEX `fk_user_memberships_membership_tiers1_idx` (`tier_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`matches` (
  ...
  INDEX `fk_matches_schedules1_idx` (`schedule_id` ASC) VISIBLE,
  INDEX `fk_matches_players1_idx` (`player_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`ticket_purchases` (
  ...
  INDEX `fk_ticket_purchases_users1_idx` (`user_id` ASC) VISIBLE,
  INDEX `fk_ticket_purchases_events1_idx` (`event_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`order_items` (
  ...
  INDEX `fk_order_items_gear1_idx` (`gear_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`news` (
  ...
  PRIMARY KEY (`news_id`),
  INDEX `fk_news_users1_idx` (`users_user_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`faq` (
  ...
  `users_user_id` INT NOT NULL,
  PRIMARY KEY (`faq_id`),
  INDEX `fk_faq_users1_idx` (`users_user_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`user_bookmarks` (
  ...
  INDEX `fk_news_has_users_users1_idx` (`user_id` ASC) VISIBLE,
  INDEX `fk_news_has_users_news1_idx` (`news_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`shopping_cart` (
  ...
  `user_id` INT NULL,
  PRIMARY KEY (`cart_id`),
  INDEX `fk_shopping_cart_gear1_idx` (`gear_id` ASC) VISIBLE,
